...
import { ChainId, JSBI } from '@0xkilo/wagmi'
...
export default function Vote() {
  ...
  const uniAmount = useTokenBalance(account ? account : undefined, chainId ? UNI[chainId] : UNI[ChainId.WAGMI])
  const sushiAmount = useTokenBalance(
    account ? account : undefined,
    chainId ? SUSHI[chainId] : SUSHI[ChainId.WAGMI]
  )
