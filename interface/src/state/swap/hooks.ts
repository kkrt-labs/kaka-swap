...
import { Currency, CurrencyAmount, CAVAX, JSBI, Token, TokenAmount, Trade, FACTORY_ADDRESS, ChainId } from '@0xkilo/wagmi'
...
const BAD_RECIPIENT_ADDRESSES: string[] = [
  FACTORY_ADDRESS[ChainId.WAGMI], // v2 factory
  ROUTER_ADDRESS[ChainId.WAGMI] // v2 router 02
]
