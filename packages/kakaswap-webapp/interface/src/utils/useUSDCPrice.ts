...
import { ChainId, Currency, currencyEquals, JSBI, Price, WAVAX } from '@jean1011/kakarot'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
	...
	const USDC = chainId ? USDCe[chainId] : USDCe[ChainId.WAGMI]
	const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
		() => [
			...
			[wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.WAGMI ? USDC : undefined],
			[chainId ? WAVAX[chainId] : undefined, chainId === ChainId.WAGMI ? USDC : undefined]
		],
